...
(function() {
  var Validator, check, flashErrors, fs, useValidator, validateField, validates, validatorMinimumLength;
  ...
  Validator = {
    validationErrors: [],
    validate: validates = function(modelName, object, callback) {
    ...
    flashErrors: flashErrors = function(req, errors) {
    ...
    validateField: validateField = function(fieldName, fieldValidations, value) {
    ...
    useValidator: useValidator = function(fieldName, validatorName, argument, value) {
    ...
    validatorMinimumLength: validatorMinimumLength = function(fieldName, value, length) {
      var errorMessage;
